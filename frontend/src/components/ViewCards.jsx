    ...
    >
      {data.length > 0 ? (
        data.map((event, index) => (
          <Grow in={true}  key={index}  timeout={{ enter: 500, exit: 100 }} style={{ transitionDelay: `${index * 30}ms` }}>
              ...
              >
                ...
                <CardContent sx={{minHeight: "194px"}}>
                  ...
                  >
                    ...
                    >
                      {Colombia.find(ciudad => ciudad.ciudadId === event.cityId).ciudad}
                    </Typography>
                    <Chip
                      color="info"
                      icon={<DateIcon />}
        ...
        <Fade in={true}>
        <Card sx={{ width: "80%", height: "60%", display: "flex", flexDirection: "column", placeItems: "center", textAlign: "center" }}>
